...
GRAPPELLI_ADMIN_TITLE = "django-todo-demo"
...
ADMINS = (
    ('django-todo-demo administrator', 'donotreply@blitzagency.com'),
)
...
SECRET_KEY = r"mz5v@xb04zymf%*#b1=)%wxp0j=06ukit+(6+r6hzm6w_w+b5q"
